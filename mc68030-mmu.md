...
**[Original Documentation](https://mikro.naprvyraz.sk/docs/Coding/Atari/Maggie/MMU.TXT)**
...
- [5. Translation Control](#translation-control)
- [6. Root Pointers](#root-pointers)
  - [6.1. Root Pointer (CRP/SRP)](#root-pointer-crpsrp)
- [7. Translation Control Register](#translation-control-register)
  - [7.1. Translation Control (TC)](#translation-control-tc)
- [8. Table Indices](#table-indices)
- [9. Descriptor Fields](#descriptor-fields)
- [10. Table Entries](#table-entries)
- [11. MMU Specific Instructions](#mmu-specific-instructions)
- [12. Translation Ends Here](#translation-ends-here)
...
- Descriptor Type (DT) <br/>
  ...
  - `01` PAGE DESCRIPTOR (EARLY TERMINATION) <br/>
